...
function SignUp(){
    ...
    return(
        <form onSubmit={handleSubmit(Register)} className="lg:w-full w-72 max-w-2xl max-h-screen mt-20 mb-10 lg:mt-10 lg:p-8 p-5 overflow-auto rounded-2xl shadow-lg shadow-white">
