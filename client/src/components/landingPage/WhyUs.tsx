    ...
    return(
        <section id="why-us" className="lg:w-full lg:mt-235 mt-380 p-25">
            <div className="flex flex-col items-center justify-center lg:gap-8 gap-2">
                ...
                <div className="flex flex-row items-center justify-start gap-10 p-5 overflow-x-auto scrollbar-custom w-[20rem] lg:w-[61rem]">
                    <div className="flex flex-col gap-2 items-center text-center shrink-0 p-5 lg:h-80 h-65 lg:w-72 w-70 bg-white text-black rounded-2xl hover:scale-110 active:scale-110 transition-transform duration-800 ease-in-out">
                        <img src={whyUs1} alt="coach-student" className="lg:h-45 lg:w-35 h-35" />
