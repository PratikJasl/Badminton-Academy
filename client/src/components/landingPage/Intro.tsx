...
function Introduce(){
    return(
        <section id='introduce' className="w-screen text-start mt-15 p-5">
            <div className="flex lg:flex-row flex-col items-center 2xl:gap-120 md:gap-40 gap-5 font-poppins">
                <div className="flex flex-col lg:order-1 order-2 md:gap-15 gap-2 md:pt-15 md:p-15 pt-5">
                    <div className="flex flex-col md:items-start items-center 2xl:gap-2">
                        ...
                        <h1 className="2xl:text-[10rem] md:text-[9rem] text-6xl font-bold mt-0 mb-0 p-0">smash!</h1>
                    </div>
                    <div className="flex flex-col md:gap-2 gap-0 md:items-start items-center">
                        ...
                        <button 
                            className="font-semibold md:mt-5 mt-2 w-fit bg-green-600 text-white 2xl:text-3xl md:text-2xl text-lg p-2 px-6 lg:px-5 rounded-3xl hover:bg-green-500">
                            <a 
                                href="" 
                                target="blank">
                                Enroll Now!
                ...
                <div className='lg:order-2 order-1'>
                    ...
                    src={smash} 
                    alt="smash image"
                    className='2xl:h-200 md:h-140 h-75' />
                </div>
            </div>
        </section>
    )
