...
function UserAttendance(){
    ...
    return(
        <section id="attendance" className="">
            <div className="flex flex-col md:gap-3 gap-2 items-center text-center md:p-5 p-3 rounded-2xl lg:h-130 h-130 lg:w-200 w-74 md:mt-10 mt-1 md:mb-10 mb-2">
                ...
                <div className="flex md:flex-row flex-col md:gap-20 gap-2 mx-5 justify-between">
                    ...
                    <div className="overflow-auto space-y-4 scroll-smooth [scrollbar-width:none] border-white border-1 md:p-5 p-2 rounded-2xl lg:h-120 lg:w-210 h-110"> 
                        {attendanceData && attendanceData.length > 0 ? (
                                attendanceData.map((attendance) => (
                                    <div 
                                    key={attendance.user.userId}
                                    className="p-3 bg-gray-50 rounded-xl flex flex-row justify-between items-center relative text-black"
                                    >
