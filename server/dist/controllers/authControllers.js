...
function signUp(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            res.status(200).json({ success: true, message: errors_1.ERROR_MESSAGES.USER_CREATED });
            return;
        }
        catch (error) {
            res.status(500).json({ success: "false", message: errors_1.ERROR_MESSAGES.SERVER_ERROR, detail: error });
            return;
        }
    });
}
